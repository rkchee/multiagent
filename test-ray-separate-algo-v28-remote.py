...
class neuronetwork(TFModelV2):
    def __init__(self, obs_space, action_space, num_outputs, model_config, name):
        ...
        batchnorm_1 = tf.keras.layers.BatchNormalization()(layer_1)
        ...
        layer_dropout_2 = tf.keras.layers.Dropout(.1)(layer_2)
        ...
        layer_dropout_3 = tf.keras.layers.Dropout(0)(layer_3)
        ...
        layer_dropout_4 = tf.keras.layers.Dropout(0)(layer_4)
        ...
        layer_dropout_5 = tf.keras.layers.Dropout(0)(layer_5)
        ...
        layer_dropout_6 = tf.keras.layers.Dropout(0)(layer_6)
