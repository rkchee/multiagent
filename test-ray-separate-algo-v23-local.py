...
class realworldEnv(gym.Env):
    ...
    def buffer(self):
        ...
        # self.buffer_x = []
        # self.buffer_y = []
        # for i in range(self.buff_n):
        self.buffer_xy =  pullElement()
        # self.buffer_x = self.buffer_xy.numpy()[0]
        # self.buffer_y = self.buffer_xy.numpy()[1]
        # pdb.set_trace()

        # self.buffer_x = self.buffer_xy[0]
        # self.buffer_y = self.buffer_xy[1]
        return self.buffer_xy
