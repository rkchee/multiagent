...
class realworldEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.buffer()
        self.buffer_x = dask.compute(*self.buffer_x)
        self.buffer_y = dask.compute(*self.buffer_y)
        self.obs = self.buffer_x[local_n_ran]
        self.a = self.buffer_y[local_n_ran]
